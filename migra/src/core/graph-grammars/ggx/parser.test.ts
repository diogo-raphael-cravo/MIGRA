...
function makeMockXml(types, rules) {
    return '<?xml version="1.0" encoding="UTF-8"?>\n'
        + '<Document version="1.0">\n'
        + '    <GraphTransformationSystem name="name">\n'
...
const rulesXml = '        <Rule ID="1.GET.call-E1_AB" enabled="true" name="1.GET.call-E1_AB">\n'
    + ruleWithGraphXml
    + '<ApplCondition>\n'
    + NACXml
    + NACXml
    + '</ApplCondition>\n'
    + '        </Rule>\n'
    + '        <Rule ID="2.GET.return-E1_AB" enabled="false" name="2.GET.return-E1_AB">\n'
    + ruleWithGraphXml
    + '        </Rule>\n'
    + '        <Rule ID="require-A.A1.a1" enabled="false" name="require-A.A1.a1">\n'
    + ruleWithGraphXml
    + '        </Rule>\n'
    + '        <Rule ID="generate-A.A1.a1" enabled="false" name="generate-A.A1.a1">\n'
    + ruleWithGraphXml
    + '        </Rule>\n'
...
describe('ggx-parser', () => {
    it('parses ggx', async () => {
        const xmlToParse = makeMockXml(typesXml + graphXml, rulesXml);
        const actualGrammar = await parseXml(xmlToParse);
        expect(actualGrammar).toStrictEqual({
            version: '1.0',
            name: 'name',
            taggedValues: expectedTaggedValues,
