...
public class Transform implements GraTraEventListener {
    ...
    public static void main(String[] args) {
        ...
        DefaultGraTraImpl gratraDefault = new DefaultGraTraImpl();
        ...
        System.out.println("Transform non-deterministically:  " + graphGrammar.getName());
